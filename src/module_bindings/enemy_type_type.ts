...
export namespace EnemyType {
  ...
  export const Minion = { tag: "Minion" };

  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createSumType([
      new SumTypeVariant("Boss", AlgebraicType.createProductType([])),
      new SumTypeVariant("Minion", AlgebraicType.createProductType([])),
    ]);
  }
...
export type EnemyType = EnemyType.Boss | EnemyType.Minion;

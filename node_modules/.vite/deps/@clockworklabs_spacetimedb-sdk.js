...
var _buffer, _offset, _a;
var BinaryReader = (_a = class {
  constructor(input) {
    __privateAdd(this, _buffer);
    __privateAdd(this, _offset, 0);
    __privateSet(this, _buffer, new DataView(input.buffer));
    __privateSet(this, _offset, input.byteOffset);
  }
  get offset() {
...
var _buffer2, _view, _offset2, _BinaryWriter_instances, expandBuffer_fn, _a2;
var BinaryWriter = (_a2 = class {
  constructor(size) {
    __privateAdd(this, _BinaryWriter_instances);
  ...
  writeUInt8Array(value) {
    ...
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 4 + length);
  ...
  writeBool(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 1);
  ...
  writeI16(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 2);
  ...
  writeI32(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 4);
  ...
  writeI64(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 8);
  ...
  writeU128(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 16);
  ...
  writeU256(value) {
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, 32);
  ...
  writeString(value) {
    ...
    __privateMethod(this, _BinaryWriter_instances, expandBuffer_fn).call(this, encodedString.length);
...
}, _buffer2 = new WeakMap(), _view = new WeakMap(), _offset2 = new WeakMap(), _BinaryWriter_instances = new WeakSet(), expandBuffer_fn = function(additionalCapacity) {
  const minCapacity = __privateGet(this, _offset2) + additionalCapacity + 1;
  if (minCapacity <= __privateGet(this, _buffer2).length) return;
...
var TimeDuration = (_a3 = class {
  ...
  get millis() {
    return Number(this.micros / _a3.MICROS_PER_MILLIS);
  }
  static fromMillis(millis) {
    return new _a3(BigInt(millis) * _a3.MICROS_PER_MILLIS);
  }
}, __publicField(_a3, "MICROS_PER_MILLIS", 1000n), _a3);
var _a4;
var Timestamp = (_a4 = class {
  constructor(micros) {
   ...
   */
  static now() {
    return _a4.fromDate(/* @__PURE__ */ new Date());
  }
  /**
  ...
  static fromDate(date) {
    ...
    const micros = BigInt(millis) * _a4.MICROS_PER_MILLIS;
    return new _a4(micros);
  }
  /**
  ...
  toDate() {
    ...
    const millis = micros / _a4.MICROS_PER_MILLIS;
...
}, __publicField(_a4, "MICROS_PER_MILLIS", 1000n), /**
 * The Unix epoch, the midnight at the beginning of January 1, 1970, UTC.
 */
__publicField(_a4, "UNIX_EPOCH", new _a4(0n)), _a4);
...
var __AlgebraicType_instances, setter_fn, __AlgebraicType_static, _a5, createType_fn, isBytes_fn, isBytesNewtype_fn, isI64Newtype_fn;
var AlgebraicType = (_a5 = class {
  constructor() {
    __privateAdd(this, __AlgebraicType_instances);
  ...
  set product(value) {
    __privateMethod(this, __AlgebraicType_instances, setter_fn).call(this, Type.ProductType, value);
  }
  get sum() {
  ...
  set sum(value) {
    __privateMethod(this, __AlgebraicType_instances, setter_fn).call(this, Type.SumType, value);
  }
  get array() {
  ...
  set array(value) {
    __privateMethod(this, __AlgebraicType_instances, setter_fn).call(this, Type.ArrayType, value);
  }
  get map() {
  ...
  set map(value) {
    __privateMethod(this, __AlgebraicType_instances, setter_fn).call(this, Type.MapType, value);
  }
  static createProductType(elements) {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.ProductType, new ProductType(elements));
  }
  static createSumType(variants) {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.SumType, new SumType(variants));
  }
  static createArrayType(elementType) {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.ArrayType, elementType);
  }
  static createMapType(key, val) {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.MapType, new MapType(key, val));
  }
  static createBoolType() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.Bool, null);
  }
  static createI8Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I8, null);
  }
  static createU8Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U8, null);
  }
  static createI16Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I16, null);
  }
  static createU16Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U16, null);
  }
  static createI32Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I32, null);
  }
  static createU32Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U32, null);
  }
  static createI64Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I64, null);
  }
  static createU64Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U64, null);
  }
  static createI128Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I128, null);
  }
  static createU128Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U128, null);
  }
  static createI256Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.I256, null);
  }
  static createU256Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.U256, null);
  }
  static createF32Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.F32, null);
  }
  static createF64Type() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.F64, null);
  }
  static createStringType() {
    return __privateMethod(this, __AlgebraicType_static, createType_fn).call(this, Type.String, null);
  }
  ...
  isIdentity() {
    return __privateMethod(this, __AlgebraicType_instances, isBytesNewtype_fn).call(this, "__identity__");
  }
  isConnectionId() {
    return __privateMethod(this, __AlgebraicType_instances, isBytesNewtype_fn).call(this, "__connection_id__");
  }
  isScheduleAt() {
  ...
  isTimestamp() {
    return __privateMethod(this, __AlgebraicType_instances, isI64Newtype_fn).call(this, "__timestamp_micros_since_unix_epoch__");
  }
  isTimeDuration() {
    return __privateMethod(this, __AlgebraicType_instances, isI64Newtype_fn).call(this, "__time_duration_micros__");
  }
  serialize(writer, value) {
    switch (this.type) {
      ...
      case Type.SumType:
        ...
        break;
      case Type.ArrayType:
        if (__privateMethod(this, __AlgebraicType_instances, isBytes_fn).call(this)) {
...
}, __AlgebraicType_instances = new WeakSet(), setter_fn = function(type, payload) {
  this.type_ = payload;
  this.type = payload === void 0 ? Type.None : type;
}, __AlgebraicType_static = new WeakSet(), createType_fn = function(type, payload) {
  var _a13;
  let at = new _a5();
  __privateMethod(_a13 = at, __AlgebraicType_instances, setter_fn).call(_a13, type, payload);
  return at;
}, isBytes_fn = function() {
  return this.isArrayType() && this.array.type == Type.U8;
}, isBytesNewtype_fn = function(tag) {
...
}, __privateAdd(_a5, __AlgebraicType_static), _a5);
((AlgebraicType3) => {
  ((Type3) => {
...
var _items, _OperationsMap_instances, isEqual_fn, _a7;
var OperationsMap = (_a7 = class {
  constructor() {
    __privateAdd(this, _OperationsMap_instances);
    __privateAdd(this, _items, []);
  }
  set(key, value) {
    const existingIndex = __privateGet(this, _items).findIndex(
      ({ key: k }) => __privateMethod(this, _OperationsMap_instances, isEqual_fn).call(this, k, key)
    );
    if (existingIndex > -1) {
      __privateGet(this, _items)[existingIndex].value = value;
    } else {
      __privateGet(this, _items).push({ key, value });
    }
  }
  get(key) {
    const item = __privateGet(this, _items).find(({ key: k }) => __privateMethod(this, _OperationsMap_instances, isEqual_fn).call(this, k, key));
  ...
  delete(key) {
    ...
    if (existingIndex > -1) {
      __privateGet(this, _items).splice(existingIndex, 1);
      return true;
    }
    return false;
  }
  has(key) {
    return __privateGet(this, _items).some(({ key: k }) => __privateMethod(this, _OperationsMap_instances, isEqual_fn).call(this, k, key));
  }
  values() {
    return __privateGet(this, _items).map((i) => i.value);
  }
  entries() {
  ...
  [Symbol.iterator]() {
    let index = 0;
    const items = __privateGet(this, _items);
    return {
      next() {
...
}, _items = new WeakMap(), _OperationsMap_instances = new WeakSet(), isEqual_fn = function(a, b) {
...
var TableCache33 = class {
  ...
  constructor(tableTypeInfo) {
    ...
    __publicField(this, "update", (ctx, newDbOp, oldDbOp, refCountDelta = 0) => {
...
var _ws, __WebsocketDecompressAdapter_instances, handleOnMessage_fn, handleOnOpen_fn, handleOnError_fn, _a8;
var WebsocketDecompressAdapter = (_a8 = class {
  constructor(ws) {
    ...
    this.onmessage = void 0;
    this.onerror = void 0;
    ws.onmessage = __privateMethod(this, __WebsocketDecompressAdapter_instances, handleOnMessage_fn).bind(this);
    ws.onerror = __privateMethod(this, __WebsocketDecompressAdapter_instances, handleOnError_fn).bind(this);
    ws.onclose = __privateMethod(this, __WebsocketDecompressAdapter_instances, handleOnError_fn).bind(this);
    ws.onopen = __privateMethod(this, __WebsocketDecompressAdapter_instances, handleOnOpen_fn).bind(this);
...
}, _ws = new WeakMap(), __WebsocketDecompressAdapter_instances = new WeakSet(), handleOnMessage_fn = async function(msg) {
  var _a13;
  ...
  (_a13 = this.onmessage) == null ? void 0 : _a13.call(this, { data: decompressed });
}, handleOnOpen_fn = function(msg) {
  var _a13;
  (_a13 = this.onopen) == null ? void 0 : _a13.call(this, msg);
}, handleOnError_fn = function(msg) {
  var _a13;
  (_a13 = this.onerror) == null ? void 0 : _a13.call(this, msg);
}, _a8);
var _uri, _nameOrAddress, _identity, _token, _emitter, _compression, _lightMode, _createWSFn, _a9;
var DbConnectionBuilder32 = (_a9 = class {
  /**
...
}, _uri = new WeakMap(), _nameOrAddress = new WeakMap(), _identity = new WeakMap(), _token = new WeakMap(), _emitter = new WeakMap(), _compression = new WeakMap(), _lightMode = new WeakMap(), _createWSFn = new WeakMap(), _a9);
var _onApplied, _onError, _a10;
var SubscriptionBuilderImpl32 = (_a10 = class {
  constructor(db) {
...
var _queryId2, _emitter3, _reducerEmitter, _onApplied2, _remoteModule, _messageQueue, _subscriptionManager, _getNextQueryId, _DbConnectionImpl32_instances, processParsedMessage_fn, sendMessage_fn, handleOnOpen_fn2, applyTableUpdates_fn, processMessage_fn, handleOnMessage_fn2, on_fn, off_fn, onConnect_fn, onDisconnect_fn, onConnectError_fn, removeOnConnect_fn, removeOnDisconnect_fn, removeOnConnectError_fn, _a12;
var DbConnectionImpl32 = (_a12 = class {
  constructor({
    uri,
    nameOrAddress,
    identity,
    ...
    __privateAdd(this, _DbConnectionImpl32_instances);
    /**
    ...
    this.wsPromise = createWSFn({
      ...
      this.ws.onopen = __privateMethod(this, _DbConnectionImpl32_instances, handleOnOpen_fn2).bind(this);
      this.ws.onmessage = __privateMethod(this, _DbConnectionImpl32_instances, handleOnMessage_fn2).bind(this);
      return v;
    }).catch((e) => {
      stdbLogger("error", "Error connecting to SpacetimeDB WS");
      __privateMethod(this, _DbConnectionImpl32_instances, on_fn).call(this, "connectError", e);
      throw e;
    });
  }
  registerSubscription(handle, handleEmitter, querySql) {
    ...
    __privateMethod(this, _DbConnectionImpl32_instances, sendMessage_fn).call(this, ClientMessage.SubscribeMulti({
  ...
  unregisterSubscription(queryId) {
    __privateMethod(this, _DbConnectionImpl32_instances, sendMessage_fn).call(this, ClientMessage.UnsubscribeMulti({
      queryId: { id: queryId },
      // The TypeScript SDK doesn't currently track `request_id`s,
      // so always use 0.
      requestId: 0
  ...
  callReducer(reducerName, argsBuffer, flags) {
    ...
    __privateMethod(this, _DbConnectionImpl32_instances, sendMessage_fn).call(this, message);
  }
  /**
...
}, _queryId2 = new WeakMap(), _emitter3 = new WeakMap(), _reducerEmitter = new WeakMap(), _onApplied2 = new WeakMap(), _remoteModule = new WeakMap(), _messageQueue = new WeakMap(), _subscriptionManager = new WeakMap(), _getNextQueryId = new WeakMap(), _DbConnectionImpl32_instances = new WeakSet(), processParsedMessage_fn = async function(message) {
...
handleOnOpen_fn2 = function() {
  ...
  const message = await __privateMethod(this, _DbConnectionImpl32_instances, processParsedMessage_fn).call(this, serverMessage);
  if (!message) {
    return;
  }
  switch (message.tag) {
    case "InitialSubscription": {
      ...
      const callbacks = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext);
    ...
    case "TransactionUpdate": {
      ...
      if (unknownTransaction) {
        ...
        const callbacks2 = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext2);
    ...
    case "SubscribeApplied": {
      ...
      const { event: _, ...subscriptionEventContext } = eventContext;
      const callbacks = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext);
      subscription == null ? void 0 : subscription.emitter.emit("applied", subscriptionEventContext);
      for (const callback of callbacks) {
        callback.cb();
      }
      break;
    ...
    case "UnsubscribeApplied": {
      ...
      const { event: _, ...subscriptionEventContext } = eventContext;
      const callbacks = __privateMethod(this, _DbConnectionImpl32_instances, applyTableUpdates_fn).call(this, message.tableUpdates, eventContext);
      subscription == null ? void 0 : subscription.emitter.emit("end", subscriptionEventContext);
    ...
    case "SubscriptionError": {
      ...
      if (message.queryId !== void 0) {
        (_b = __privateGet(this, _subscriptionManager).subscriptions.get(message.queryId)) == null ? void 0 : _b.emitter.emit("error", errorContext, error);
        __privateGet(this, _subscriptionManager).subscriptions.delete(message.queryId);
      } else {
 ...
 */
handleOnMessage_fn2 = function(wsMessage) {
  __privateSet(this, _messageQueue, __privateGet(this, _messageQueue).then(() => {
    return __privateMethod(this, _DbConnectionImpl32_instances, processMessage_fn).call(this, wsMessage.data);
  }));
}, on_fn = function(eventName, callback) {
  __privateGet(this, _emitter3).on(eventName, callback);
}, off_fn = function(eventName, callback) {
  __privateGet(this, _emitter3).off(eventName, callback);
}, onConnect_fn = function(callback) {
  __privateGet(this, _emitter3).on("connect", callback);
}, onDisconnect_fn = function(callback) {
  __privateGet(this, _emitter3).on("disconnect", callback);
}, onConnectError_fn = function(callback) {
  __privateGet(this, _emitter3).on("connectError", callback);
}, removeOnConnect_fn = function(callback) {
  __privateGet(this, _emitter3).off("connect", callback);
}, removeOnDisconnect_fn = function(callback) {
  __privateGet(this, _emitter3).off("disconnect", callback);
}, removeOnConnectError_fn = function(callback) {
...
export {
  ...
  ClientCache,
  ConnectionId,
  DbConnectionBuilder32 as DbConnectionBuilder,
  DbConnectionImpl32 as DbConnectionImpl,
  Identity,
  ProductType,
  ProductTypeElement,
  ProductValue,
  ScheduleAt,
  SubscriptionBuilderImpl32 as SubscriptionBuilderImpl,
  SumType,
  SumTypeVariant,
  TableCache33 as TableCache,
  TimeDuration,
  Timestamp,
  deepEqual
};
//# sourceMappingURL=@clockworklabs_spacetimedb-sdk.js.map
